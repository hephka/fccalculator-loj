...
- **`herostars.html`** — Hero Stars & Exclusive Equipment: up to 6 heroes independently on each side — a Star-progress track (recruit for 10 Hero Fragments at 0 stars, then 5 stars costing 10/40/115/300/600 Fragments — 1,075 total to max) and an Exclusive Equipment track (Level 0 → 10, 550 Exclusive Equipment Pieces total). "Actuel" breaks each star down palier by palier; "Cible" only offers whole completed stars.
