...
| `tomes-collections.html` | 6 tomes per troop type, and the Trove Collection sequence | Seal of Wisdom/Knowledge/Mystery Tome, 4 Trove Coins |
...
- **`tomes-collections.html`** — Tomes & Collections: all 6 tomes per troop type (Level 0 → 18), and the Trove Collection sequence (Uncommon → Exotic T3). Resources: Seal of Wisdom, Seal of Knowledge, Seal of Mystery Tome (levels 13-18 only), Common/Rare/Precious/Legendary Trove Coin.
