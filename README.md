...
- **`heroequipment.html`** — Hero Equipment: Gloves/Helmet/Chest/Boots for each of the 3 troop types (12 pieces total), Level 0 → 200 (Common through Exotic T3/Master T3), plus each piece's own Equipment Reformation (Level 0 → 20) — reaching Legendary T2 (Level 120) requires that piece's Reformation at Level 10. Resources: Equipment Parts, Magnet, Potential Coil, Precision Equipment.
